window.addEventListener('DOMContentLoaded', () => {
	...
	const formSubmitButton = document.querySelector('.submitFormButton')
	const singUpCircle = document.querySelector('.sing-up__circle__shape')
	const selectedCourseSingUpPanelLabel = document.querySelectorAll('#selectedCourseDisplay')
	const aboveFormTexts = document.querySelectorAll('.sing-up__form__texts')
	const singUpForm = document.querySelector('.sing-up__form form')
	...
	let correctFormStateDisplay = () => {
		singUpCircle.classList.toggle('submitted')
	...
	window.setInterval(changeOpinion, 6000)
